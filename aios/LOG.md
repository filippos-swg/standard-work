# standardwork.design — Decision & Change Log
...
**Provenance.** Everything below 2026-08-25 is transcribed verbatim from the v1.3 DECISIONS.md,
which this file replaces under AiOS v2.0. No decision was reworded, dropped or re-dated in the
move; the founding block keeps the file's own `**Decision** · why · trade-off accepted` shape
because rewriting it would have been the one thing a migration must not do. Dates before
2026-08-25 are the dates those decisions were logged, not the date of this file.
...
## 2026-08-26 · 2026-08-25 — Brand DNA, the handover, and the fixes it needed
**Status:** APPROVED
**Evidence:** the working sessions of both dates, each decision attributed inline to Filippos
where he took it. `tests.html` asserts the arithmetic; the commit messages on
`brand-dna-2026-08` carry the measurements.
...
## 2026-07-18 — Migrated to AIOS v1.3

Core files moved into `aios/`: PROJECT_BRIEF (was root), AI_HANDOFF + DECISIONS (were
`docs/`), TASK_001 (was `tasks/`). MVP_SCOPE and ARCHITECTURE moved from root to `docs/`.
Added a root `CLAUDE.md` pointer and a `PROJECT_CANON.md` placeholder. Structure only — no
content changed. Superseded 2026-08-26 by the move to v2.0.

---

## 2026-06-16 — Founding decisions: product, technical, infrastructure, design
**Status:** APPROVED
**Evidence:** carried unchanged from the v1.3 DECISIONS.md, where they were the original entries.
Undated there; 2026-06-16 is the date the file and `PRICING.md` were established.
